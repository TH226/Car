 ...
 */
public class NowMarkActivity extends Activity implements View.OnClickListener{
    private ImageView ReturnHome;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.now_mark_activity);
        initView();
    }

    private void initView() {
        ReturnHome = (ImageView) findViewById(R.id.iv_mark_return_home);
