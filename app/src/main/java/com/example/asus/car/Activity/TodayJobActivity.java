 ...
 */
public class TodayJobActivity extends Activity implements View.OnClickListener{
    private ImageView ReturnHome;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.today_job_activity);
        initView();
    }

    private void initView() {
        ReturnHome = (ImageView) findViewById(R.id.iv_job_return_home);
